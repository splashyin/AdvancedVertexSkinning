...
void Mesh::SetVertexBoneData(
    const std::vector<VertexBoneData> &i_vertexBoneData) {
...
void Mesh::InitializeBuffer() {
  ...
  // glVertexAttribPointer( 3, 3, GL_FLOAT, GL_FALSE, sizeof( Vertex ), ( void*
  ...
  glEnableVertexAttribArray(4);
  glVertexAttribPointer(4, NUM_BONES_PER_VERTEX, GL_FLOAT, GL_FALSE,
